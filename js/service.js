class UserService {
    static login(email, password) {
        const selectedData = {
            ...
            fields: ["id", "email","role","donorStatus"]
    ...
    static userList() {
        ...
        const dbpassword = "ec6094ae0714dc7a5ffc50a86924bef3";
        const basicAuth = "Basic " + btoa(dbusername + ":" + dbpassword);
        const url = "https://fffdcced-9a09-44ae-aa2f-e27add7efeb7-bluemix.cloudantnosqldb.appdomain.cloud/blood_app/_all_docs?include_docs=true";
